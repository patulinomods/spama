...
class StatusDecorator(object):
    def __init__(self):
        self.PASS = Style.BRIGHT + Fore.GREEN + "[ Sucesso ]" + Style.RESET_ALL
        self.FAIL = Style.BRIGHT + Fore.RED + "[ Falho ]" + Style.RESET_ALL
        self.WARN = Style.BRIGHT + Fore.YELLOW + "[ perigo ]"\
            + Style.RESET_ALL
        self.HEAD = Style.BRIGHT + Fore.CYAN + "[ SEÇÃO ]" + Style.RESET_ALL
        self.CMDL = Style.BRIGHT + Fore.BLUE + "[ COMANDO ]" + Style.RESET_ALL
        self.STDS = "           "
